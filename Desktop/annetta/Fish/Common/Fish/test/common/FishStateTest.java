...
public class FishStateTest {
  ...
  public void init() {
    ...
    fourByEightFishModel.createHole(3, 0);
    width2 = 1;
    height2 = 3;
...
//    assertEquals(0, penguinY1);
  ...
  @Test
  public void placePenguinFailed6() {
    try {
      gameState1.placeInitPenguin(0, 3, playerInfoRed);
    } catch (IllegalArgumentException e) {
      assertEquals("Error: Target tile is a hole", e.getMessage());
    }
  }
  ...
  @Test
  public void makeMovementFailed5() {
    FishState nextState1 = gameState1.placeInitPenguin(0, 0, playerInfoRed);
    ...
    try {
      currentPlayerIndex = nextState4.getCurrentPlayerIndex();
      Penguin penguinBlack = nextState4.getPenguinsOnBoard().get(2);
      ArrayList<PlayerInfo> players4 = nextState4.getAllPlayerInfos();
      playerInfoBlack = players4.get(currentPlayerIndex);
      FishState nextState5 = nextState4.makeMovement(3, 0, penguinBlack, playerInfoBlack);
    } catch (IllegalArgumentException e) {
      assertEquals("Error: Error: Target tile is a hole.", e.getMessage());
    }
  }
